...

{
    ...
    public void onLocationChanged(Location location) {
        ...
        if(myLocation!=null) {
            ...
            if(!getvolunteeraround && !getneedyaround ){
                getclosedvolunteer();
    ...
    private void checkPermission() {
        int permissionLocation= ContextCompat.checkSelfPermission(MapsActivity2.this, Manifest.permission.ACCESS_FINE_LOCATION);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                startActivity(new Intent(MapsActivity2.this, welcome.class));
                finish();
                return true;
        }
