...
public class newprofile extends AppCompatActivity {
        ...
        navigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if(id==R.id.profile){
                    ...
                    volprofile fragment=new volprofile();
                    FragmentTransaction fragmentTransaction=getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.frame_layout,fragment);
                    fragmentTransaction.commit();
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_aboutus) {
            ...
            startActivity(new Intent(newprofile.this,volunteerabout.class));
            return true;
        }
        else if (id == R.id.action_mapview) {
            FirebaseAuth.getInstance().signOut();
            startActivity(new Intent(newprofile.this, MapsActivity2.class));
            finish();
        }
            ...
            FirebaseAuth.getInstance().signOut();
            startActivity(new Intent(newprofile.this, LoginActivity.class));
            finish();
        }
